...
class FirestoreManager: ObservableObject {
    ...
    func fetchFirebaseData() async {
        ...
        do {
            ...
            fetchedData = querySnapshot.documents.compactMap { $0.data()["name"] as? String} // Like a dictionary, just use the names in the firestore database (ex: name, id, muscle_groups, etc)
